...
The overall architecture of our 3-Pillar Framework integrates kinematic feature engineering (Fig.~\ref{fig:feature_importance}), cost-sensitive threshold adjustment (Fig.~\ref{fig:dat_cost}), and edge quantization (Fig.~\ref{fig:tinyml_pareto}) for O-RAN Near-RT RIC xApps.
